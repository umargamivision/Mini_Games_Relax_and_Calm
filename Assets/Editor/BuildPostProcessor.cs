...
public class BuildPostProcessor : MonoBehaviour
{
    ...
    public static void EmbedSignFramework(string path)
    {
        ...
        string frameworkPath1 = Path.Combine(extractionPath, "TenjinSDK.xcframework");
        string fileGuid = proj.AddFile(frameworkPath1, "Frameworks/TenjinSDK.xcframework");
        proj.AddFileToEmbedFrameworks(targetGuid, fileGuid);

        string fileGuidForUnityFramework = proj.AddFile(frameworkPath1, "Frameworks/TenjinSDK.xcframework");
