...
public class AndroidTenjin : BaseTenjin
{
	...
	public override void SubscribeAdMobAppOpenViewImpressions(object appOpen, string adUnitId)
	{
		Debug.Log("Subscribing to AdMob appOpen ILRD");
		TenjinAdMobIntegration.ListenForAppOpenViewImpressions(appOpen, adUnitId, AdMobAppOpenImpressionHandler);
	}

	public override void SubscribeAdMobAdaptiveBannerViewImpressions(object adaptiveBannerView, string adUnitId)
	{
		Debug.Log("Subscribing to AdMob adaptiveBannerView ILRD");
		TenjinAdMobIntegration.ListenForAdaptiveBannerViewImpressions(adaptiveBannerView, adUnitId, AdMobAdaptiveBannerViewImpressionHandler );
	}
	...
	public override void SubscribeAdMobMRecImpressions(object mrecView, string adUnitId)
	{
		Debug.Log("Subscribing to AdMob mrecView ILRD");
		TenjinAdMobIntegration.ListenForMRecViewImpressions(mrecView, adUnitId, AdMobMrecViewImpressionHandler);
	}
	...
	public override void SubscribeAdMobInterstitialAdStaticImpressions(object interstitialAd, string adUnitId)
	{
		Debug.Log("Subscribing to AdMob interstitialAd Static ILRD");
		TenjinAdMobIntegration.ListenForInterstitialAdStaticImpressions(interstitialAd, adUnitId, AdMobInterstitialAdStaticImpressionHandler);
	}

	public override void SubscribeAdMobInterstitialAdVideoImpressions(object interstitialAd, string adUnitId)
	{
		Debug.Log("Subscribing to AdMob interstitialAd Video ILRD");
		TenjinAdMobIntegration.ListenForInterstitialAdVideoImpressions(interstitialAd, adUnitId, AdMobInterstitialAdVideoImpressionHandler);
	}
	...
	private void AdMobAppOpenImpressionHandler(string json)
	{
		Debug.Log($"Got admob appOpen ILRD data {json}");
		var args = new object[] { json };
		tenjinJava.Call("eventAdImpressionAdMob", args);
	}
	...
	private void AdMobAdaptiveBannerViewImpressionHandler(string json)
	{
		Debug.Log($"Got admob adaptiveBannerView ILRD data {json}");
		var args = new object[] {json};
        tenjinJava.Call ("eventAdImpressionAdMob", args);
	}

	private void AdMobMrecViewImpressionHandler(string json)
	{
		Debug.Log($"Got admob mrecView ILRD data {json}");
		var args = new object[] { json };
		tenjinJava.Call("eventAdImpressionAdMob", args);
	}
	...
	private void AdMobInterstitialAdStaticImpressionHandler(string json)
	{
		Debug.Log($"Got admob interstitialAd Static ILRD data {json}");
		var args = new object[] { json };
		tenjinJava.Call("eventAdImpressionAdMob", args);
	}

	private void AdMobInterstitialAdVideoImpressionHandler(string json)
	{
		Debug.Log($"Got admob interstitialAd Video ILRD data {json}");
		var args = new object[] {json};
        tenjinJava.Call ("eventAdImpressionAdMob", args);
	}
	...
	public override void SubscribeAdMobAppOpenViewImpressions(object appOpen, string adUnitId)
	{
		Debug.Log("Sending AndroidTenjin:: SubscribeAdMobAppOpenViewImpressions ");
	}
	...
	public override void SubscribeAdMobAdaptiveBannerViewImpressions(object adaptiveBannerView, string adUnitId)
	{
		Debug.Log("Sending AndroidTenjin:: SubscribeAdMobAdaptiveBannerViewImpressions ");
	}

	public override void SubscribeAdMobMRecImpressions(object mrecView, string adUnitId)
	{
		Debug.Log("Sending AndroidTenjin:: SubscribeAdMobMRecImpressions ");
	...
	public override void SubscribeAdMobInterstitialAdStaticImpressions(object interstitialAd, string adUnitId)
	{
		Debug.Log("Sending AndroidTenjin:: SubscribeAdMobInterstitialAdStaticImpressions ");
	}

	public override void SubscribeAdMobInterstitialAdVideoImpressions(object interstitialAd, string adUnitId)
	{
		Debug.Log("Sending AndroidTenjin:: SubscribeAdMobInterstitialAdVideoImpressions ");
	}
