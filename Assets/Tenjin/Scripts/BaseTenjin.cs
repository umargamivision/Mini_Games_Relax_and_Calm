...
public abstract class BaseTenjin : MonoBehaviour
{
    ...
    public string SdkVersion { get; } = "1.15.2";
    ...
    public abstract void SubscribeAdMobAppOpenViewImpressions(object appOpen, string adUnitId);
    public abstract void SubscribeAdMobBannerViewImpressions(object bannerView, string adUnitId);
    public abstract void SubscribeAdMobAdaptiveBannerViewImpressions(object adaptiveBannerView, string adUnitId);
    public abstract void SubscribeAdMobMRecImpressions(object mrecView, string adUnitId);
    public abstract void SubscribeAdMobRewardedAdImpressions(object rewardedAd, string adUnitId);
    public abstract void SubscribeAdMobInterstitialAdVideoImpressions(object interstitialAd, string adUnitId);
    public abstract void SubscribeAdMobInterstitialAdStaticImpressions(object interstitialAd, string adUnitId);
