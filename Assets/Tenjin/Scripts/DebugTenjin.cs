...
public class DebugTenjin : BaseTenjin
{
    ...
    {
        Debug.Log("Subscribing to admob appOpen impressions");
    ...
    {
        Debug.Log("Subscribing to admob adaptiveBannerView impressions");
    ...
    {
        Debug.Log("Subscribing to admob interstitialAd Static impressions");
    ...
    {
        Debug.Log("Subscribing to admob interstitialAd Video impressions");
    ...
    {
        Debug.Log($"Got admob appOpen impression data {json}");
    }
    ...
    {
        Debug.Log($"Got admob mrecView impression data {json}");
    }
    ...
    {
        Debug.Log($"Got admob interstitialAd Static impression data {json}");
    }

    private void AdMobInterstitialAdVideoImpressionHandler(string json)
    {
        Debug.Log($"Got admob interstitialAd Video impression data {json}");
    }
