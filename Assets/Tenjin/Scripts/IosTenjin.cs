...
public class IosTenjin : BaseTenjin
{
    ...
    {
        TenjinAdMobIntegration.ListenForAppOpenViewImpressions(appOpen, adUnitId, AdMobAppOpenILRDHandler);
    }
    ...
    {
        TenjinAdMobIntegration.ListenForAdaptiveBannerViewImpressions(adaptiveBannerView, adUnitId, AdMobAdaptiveBannerViewILRDHandler);
    }

    public override void SubscribeAdMobMRecImpressions(object mrecView, string adUnitId)
    {
        TenjinAdMobIntegration.ListenForMRecViewImpressions(mrecView, adUnitId, AdMobMRecILRDHandler);
    }
    ...
    {
        TenjinAdMobIntegration.ListenForInterstitialAdStaticImpressions(interstitialAd, adUnitId, AdMobInterstitialAdStaticILRDHandler);
    }

    public override void SubscribeAdMobInterstitialAdVideoImpressions(object interstitialAd, string adUnitId)
    {
        TenjinAdMobIntegration.ListenForInterstitialAdVideoImpressions(interstitialAd, adUnitId, AdMobInterstitialAdVideoILRDHandler);
    }
    ...
    public void AdMobAppOpenILRDHandler(string json)
    {
        if (!string.IsNullOrEmpty(json))
        {
            Debug.Log($"Got AdMob AppOpen ILRD impression data {json}");
            iosTenjinAdMobImpressionFromJSON(json);
        }
    }
    ...
    public void AdMobAdaptiveBannerViewILRDHandler(string json)
    {
        if (!string.IsNullOrEmpty(json))
        {
            Debug.Log($"Got AdMob AdaptiveBannerView ILRD impression data {json}");
            iosTenjinAdMobImpressionFromJSON(json);
        }
    }

    public void AdMobMRecILRDHandler(string json)
    {
        if (!string.IsNullOrEmpty(json))
        {
            Debug.Log($"Got AdMob MRec ILRD impression data {json}");
            iosTenjinAdMobImpressionFromJSON(json);
        }
    }
    ...
    public void AdMobInterstitialAdStaticILRDHandler(string json)
    {
        if(!string.IsNullOrEmpty(json))
        {
            Debug.Log($"Got AdMob InterstitialAd Static ILRD impression data {json}");
            iosTenjinAdMobImpressionFromJSON(json);
        }
    }

    public void AdMobInterstitialAdVideoILRDHandler(string json)
    {
        if (!string.IsNullOrEmpty(json))
        {
            Debug.Log($"Got AdMob InterstitialAd Video ILRD impression data {json}");
            iosTenjinAdMobImpressionFromJSON(json);
        }
    }
    ...
    public override void SubscribeAdMobAppOpenViewImpressions(object appOpen, string adUnitId)
    {
        Debug.Log("iOS SubscribeAdMobAppOpenViewImpressions");
    }
    ...
    public override void SubscribeAdMobAdaptiveBannerViewImpressions(object adaptiveBannerView, string adUnitId)
    {
        Debug.Log("iOS SubscribeAdMobAdaptiveBannerViewImpressions");
    }

    public override void SubscribeAdMobMRecImpressions(object mrecView, string adUnitId)
    {
        Debug.Log("iOS SubscribeAdMobMRecImpressions");
    }
    ...
    public override void SubscribeAdMobInterstitialAdStaticImpressions(object interstitialAd, string adUnitId)
    {
        Debug.Log("iOS SubscribeAdMobInterstitialAdStaticImpressions");
    }

    public override void SubscribeAdMobInterstitialAdVideoImpressions(object interstitialAd, string adUnitId)
    {
        Debug.Log("iOS SubscribeAdMobInterstitialAdVideoImpressions");
    }
